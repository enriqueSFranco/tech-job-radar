export function SearchForm() {
  return (
    <form className="flex gap-4 w-1/2 m-auto">
      <div className="rounded-full outline-[1px] outline-white/20 w-full h-12 flex items-center justify-between">
        ...
        {/* TODO: Verificar si esta en modo mobile o tablet para ocultar el input, de lo contrario hay que mostrarlo  */}
        <div className="flex items-center justify-center px-4 w-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="#080D39"
